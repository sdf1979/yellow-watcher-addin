...
private:
    ...
    variant_t executeAndCalculateHash(const variant_t& query, const variant_t& column, const variant_t& timeout);
    variant_t execute(const variant_t& query, const variant_t& timeout);
